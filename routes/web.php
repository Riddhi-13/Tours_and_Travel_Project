...
Route::get('/bookTour',[BookingController::class,'index2']);
Route::post('/bookform',[BookingController::class,'book'])->name('bookform');

Route::get('/bookdisplay',[PackageController::class,'display2']);
